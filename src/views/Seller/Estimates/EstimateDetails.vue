...
<div class="my-6 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" >
    ...
    <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
            ...
            <div v-if="estimate.proposals_by_seller.length == 1 ? !estimate.proposals_by_seller[0].status == 5:true" class="flex -mx-3 justify-end">
                <div v-if="!loader.loading" class="w-1/2 mb-5 ">
                    <label for="" class="text-xs font-semibold px-1"></label>
                    <div class="flex mr-3">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                        <button @click="showDeclineModal()" class="w-full flex items-center justify-center bg-red-500 text-white font-semibold rounded hover:bg-red-700 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
                            <span class="justify-center">Recusar</span>
                        </button>  
                        <button @click="showConfirmModal()" class="w-full ml-3 flex items-center justify-center bg-primary-main text-white font-semibold rounded hover:bg-primary-darker hover:text-white shadow-md py-2 px-6 inline-flex items-center">
                            <span class="justify-center">Fazer Oferta</span>
                        </button>            
                    </div>  
                </div>
            </div>
            ...
            <div class="flex -mx-3 justify-end">
                <div v-if="!loader.loading" class="w-1/4 mb-5 ">
                    <label for="" class="text-xs font-semibold px-1"></label>
                    <div class="flex mr-3">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                        <button @click="() => (this.$router.push({name: 'estimates'}))" class="w-full flex items-center justify-center bg-gray-500 text-white font-semibold rounded hover:bg-gray-700 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
