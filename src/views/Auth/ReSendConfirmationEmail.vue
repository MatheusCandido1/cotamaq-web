      ...
      <div class="md:flex w-full">
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
          ...
          <form @submit.prevent="recoverPassword">
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button :disabled="loader.loading" type="submit" class="block w-full max-w-xs mx-auto bg-primary-main hover:bg-primary-lighter focus:bg-primary-lighter text-white rounded-lg px-3 py-3 font-semibold">Confirmar email </button>
              </div>
            </div>
            ...
            <p class="text-sm text-center text-gray-600">Já tem uma conta? <router-link class="text-primary-main underline font-bold" :to="{name: 'login'}">Entrar </router-link> </p>
  ...
  methods: {
    recoverPassword() {
      ...
      if(this.$v.email.$invalid) {
        ...
        userService.ReSendRecoverPassword(payload).then((response) => {
