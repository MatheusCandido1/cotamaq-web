<template>
  <div
    class="min-w-screen min-h-screen bg-gradient-to-r from-primary-darker via-primary-main to-primary-lighter flex items-center justify-center px-5 py-5"
  >
    <div
      class="bg-gray-100 text-gray-500 rounded-xl shadow-xl w-full overflow-hidden"
          ...
          <form @submit.prevent="register">
            <div class="-mx-3 md:flex mb-6">
              <div class="w-full px-3 mb-2 md:mb-0">
                <label
                  for="company_name"
                  class="text-sm font-semibold text-gray-600 px-1"
                >
                  Nome ou Razão Social
                </label>
                <input
                  @change="() => (errors.company_name = null)"
                  :class="
                ...
                >
                  <span class="text-xs text-red-400 font-semibold px-1 mt-1">{{
            ...
            <div class="-mx-3 md:flex mb-6">
              <div class="md:w-1/2 px-3 mb-2 md:mb-0">
                ...
                <the-mask
                  ...
                  v-model="cnpj"
                  type="text"
                  @change="() => (errors.cnpj = null)"
                  :class="
                    errors.cnpj && errors.cnpj[0]
                      ? 'border-red-400'
                      : 'border-primary-main'
                  "
                  class="w-full pl-2 pr-3 py-2 rounded border-b-2 shadow-md py-2 px-6 outline-none  focus:border-primary-lighter"
            ...
            <div class="-mx-3 md:flex mb-6">
              <div class="w-full px-3 mb-5">
                <label
                  for=""
                  class="flex text-sm font-semibold text-gray-600 px-1 justify-center "
                  >Qual seu papel?</label
                >
                <div class="flex justify-center space-x-4 mt-3">
                  <div>
                    ...
                    />
                    <label
                      :class="errors.role_id ? 'border-red-300' : ''"
                      class="flex h-9 p-1 border-2 border-gray-400 cursor-pointer rounded-md justify-items-center align-items-center"
                      for="radio_1"
                    >
                      <span
                        class="flex items-center justify-center text-gray-900 text-sm font-semibold mr-1"
                        ><i
                          class="mdi mdi-currency-usd text-gray-900 text-lg mr-1 ml-1"
                        ></i
                        >Comprador
                      </span>
                    </label>
                  ...
                  <div>
                    ...
                    <label
                      :class="errors.role_id ? 'border-red-300' : ''"
                      class="flex h-9 p-2 border-2 border-gray-400 cursor-pointer rounded-md justify-items-center align-items-center"
                      for="radio_2"
                    >
                      <span
                        class="flex items-center justify-center text-gray-900 text-sm font-semibold mr-1"
                        ><i
                          :class="errors.role_id ? 'border-red-300' : ''"
                          class="mdi mdi-wallet-travel text-gray-900 text-lg mr-1 ml-1"
                        ></i
                        >Vendedor
                      </span>
                    </label>
              ...
              <div class="md:w-full px-3">
                ...
                >
                  <span class="justify-center"
                    >Criar Conta <i class="mdi mdi-login text-lg"></i
                  ></span>
                </button>
              </div>
            </div>
