  ...
  <div class="relative bg-white   overflow-hidden rounded-xl w-64 my-4 shadow-xl">
      <div class="flex flex-col min-h-full">
        ...
        <div class="px-6 py-4 border-b bg-primary-main">
          ...
          <div class="text-md text-center text-white font-semibold">{{product.equipment}}</div>
        </div>
        <div class="px-2 py-2 flex-grow">
            <ul class="flex space-x-2 justify-end">
                <li class="bg-blue-400 text-white text-xs text-md px-4 py-1 rounded-md">{{product.category}} </li>
            </ul>
          <div class="mt-1 px-2 ">
                ...
                <div class="flex space-x-2 text-gray-800 text-sm my-3">
                     <p>Aceita Similar: {{product.allow_similar}}</p> 
                </div>
                <div class="flex space-x-2 text-gray-800 text-sm my-3">
        ...
        <div class="border-t-2"></div>
         <div class="flex justify-between px-4 ">
                    ...
                    <div class="my-2">
                        <span class="badge mb-3 bg-primary-main rounded-lg px-2 py-1 text-center object-right-top text-white text-sm mr-1 font-bold">{{product.proposals}}</span>
                    </div>
                </div>
        <div class="flex justify-between px-4 ">
                    <div class="my-2">
                        <div class="w-full  bg-red-500 text-sm px-2 py-1 font-semibold text-white rounded-lg dark:text-white">
                             Cancelado
                        </div>
                    </div>
                    <div class="my-2 ml-2">
                        <div class="flex items-center space-x-1 text-sm">
                            ...
                            <button class="flex items-center justify-between px-2 py-2 bg-primary-lighter text-sm font-medium leading-5 text-white rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
