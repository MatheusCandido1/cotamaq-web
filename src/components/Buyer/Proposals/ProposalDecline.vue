              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  ...
                  <p class="text-sm text-gray-600 mt-3">
                   Ao recusar, você <span class="font-bold">NÃO</span> poderá aceitar mais esta proposta!
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    declineProposal() {
      proposalService.declineProposalByBuyer(this.selectedProposal.id).then((response) => {
