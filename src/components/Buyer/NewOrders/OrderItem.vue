<template>
    <div class="relative bg-white   overflow-hidden rounded-xl w-full my-4 shadow-xl">
        ...
        <div class="px-2 py-2 flex-grow">
            <ul class="flex space-x-2 mb-2 justify-between">
            ...
            <div class="mt-1">
                <div class="flex space-x-2 text-gray-800 text-sm my-3">
                     <p><span class="font-bold">Revenda:</span> tt {{formatMissingInformation(order.proposal.user.company.company_name)}}</p>
                </div>
                <div class="flex space-x-2 text-gray-800 text-sm my-3">
            ...
            <div class="my-2">
                ...
                <div class="my-2 ml-2">
                    <div class="flex items-center space-x-1 text-sm">
                        <svg v-if="order.status == 2" v-tooltip="{ content: 'Adicionar forma de pagamento' }"  @click="handleOrderClick"  xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 animate-bounce text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
