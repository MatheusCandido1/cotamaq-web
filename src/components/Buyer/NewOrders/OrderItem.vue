            ...
            <div class="my-2">
                ...
                <div class="my-2 ml-2">
                    <div class="flex items-center space-x-1 text-sm">
                        ...
                        <a target="_blank" :href="'https://stage.cotamaq.com.br/api/v1/orders/' + order.id + '/pdf'" v-tooltip="{ content: 'Imprimir' }"  class="flex items-center justify-between px-2 py-2 bg-orange-500 text-sm font-medium leading-5 text-white rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
