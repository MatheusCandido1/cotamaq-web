  ...
  <div>
    ...
    >
      <div class="flex -mx-3">
        ...
        <div class="w-1/5 px-3 mb-5">
          ...
          <div class="flex">
            ...
            ></div>
            <input
              v-model="filter.input.data.value"
              type="text"
              class="
                w-full
                -ml-10
          ...
          <div class="flex">
            ...
            <select
              ...
              class="
                ...
                px-6
                outline-none
                focus:border-primary-lightercursor-pointer
              "
            >
      ...
      <span
        ...
        v-if="estimates && estimates.length === 0"
      >
        {{
          loader.loading ? "Carregando..." : "Nenhum cotação encontrada..."
        }}</span
      >
        ...
        >
          ...
          >
            <tr
              ...
              "
            >
              <v-th class="text-center" style="width: 10%" sortKey="id"
                >Cotação</v-th
              >
              <v-th class="text-center" style="width: 5%" sortKey="created_at"
                >Data</v-th
              >
              <v-th
                class="text-center"
                style="width: 20%"
                sortKey="equipment.description"
                >Equipamento</v-th
              >
              <v-th class="text-center" style="width: 10%" sortKey="proposals"
                >Propostas</v-th
              >
              <v-th class="text-center" style="width: 15%" sortKey="observation"
                >Observação</v-th
              >
              <v-th class="text-center" style="width: 25%" sortKey="status"
                >Situação</v-th
              >
          ...
          >
            <tr v-for="row in displayData" :key="row.id">
              ...
              <td v-else class="text-sm text-center">
                <span class="flex justify-center">
                  <div
                    :class="formatDefault(row.status)"
                    class="
                      w-1/2
                      text-sm
                      px-2
