                ...
                <div class="mt-2">
                  ...
                  <div class="flex flex-row ">
                    ...
                    <div class="px-2  ">
                          ...
                          <div class="flex space-x-2 text-gray-800 text-sm my-3">
                              <p class="break-all"><span class="font-bold">Marca:</span> {{selectedPart.brand == '' || !selectedPart.brand ? 'Não Informado':selectedPart.brand}}</p> 
                          </div>
                          <div class="flex space-x-2 text-gray-800 text-sm my-3">
                              <p class="break-all"><span class="font-bold">Observação:</span> {{selectedPart.observation == '' || !selectedPart.observation ? 'Não Informado':selectedPart.observation}}</p> 
                          </div>
                    </div>
                  </div>
                  </div>
