            ...
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  {{product.status == 5 ? 'Deletar cotação?':'Cancelar cotação?'}}
                </h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                  {{product.status == 5 ? 'Tem certeza que deseja excluir essa cotação?':'Tem certeza que deseja cancelar essa cotação?'}}
                  </p>
                </div>
              </div>
            </div>
