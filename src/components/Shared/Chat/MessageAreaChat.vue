  ...
  <span v-else class="w-full h-full flex flex-col justify-between">
    ...
    <div class="flex items-center justify-between px-3 py-3">
      ...
      <span class="buttons flex items-center justify-evenly">
        ...
        <button v-tooltip="{ content: 'Escolher arquivo' }" onclick="document.getElementById('fileInput').click()" class="focus:outline-none">
        ...
        <button type="submit" @click="sendMessage" :disabled="message == ''" class="focus:outline-none">
