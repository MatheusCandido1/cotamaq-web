          ...
          <div class="flex items-center w-full">
            ...
            <div class="ml-3 w-full">
              <div class="w-full items-center flex justify-between">
                <h5 class="font-bold truncate w-40">{{ conversation.user }}</h5>
                <p class="text-gray-500 text-sm">{{formatDate(conversation.lastMessageDateTime)}}</p>
              </div>
              <span :class="conversation.lastMessageIsImage == 1 && 'flex items-center'">
                ...
                <p v-else class="text-gray-500 text-sm truncate w-48">{{conversation.lastMessage}}</p>
              </span>
            </div>
          </div>
        </div>
