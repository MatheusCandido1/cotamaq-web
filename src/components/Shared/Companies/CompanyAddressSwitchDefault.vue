            ...
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  Mudar endereço padrão
                </h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    tem certeza que deseja alterar seu endereço padrão?
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    switchDefaultAddress() {
            ...
            companyService.setDefaultAddress(addressId).then((response) => {
