              ...
              <div class="md:flex -mx-3">
                    ...
                    <div class="md:flex  md:flex-wrap -mx-3">
                        ...
                        <div class="lg:w-1/4 md:w-1/2 sm:w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                                <input :disabled="!edit" :class="!edit ? 'text-gray-500':'text-black'" v-model="company.city_vat" placeholder="" type="text" class="w-full -ml-10 pl-2 pr-3 py-2 rounded border-b-2 border-primary-main shadow-md py-2 px-6 outline-none  focus:border-primary-lighter">
                            </div>                         
                        </div>
                    </div>
                     <div class="flex -mx-3">
                        <div class="md:w-1/2 w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                                <the-mask  :class="errors.phone == 'ERROR' ? 'border-red-400':'border-primary-main'"   @change.native="() => (errors.phone = 'OK')"  :mask="['(##) ####-####', '(##) #####-####']" :disabled="!edit" v-model="company.phone" placeholder="" type="text" class="w-full -ml-10 pl-2 pr-3 py-2 rounded border-b-2 shadow-md py-2 px-6 outline-none  focus:border-primary-lighter"></the-mask>
                            </div>    
                            <div v-if="errors.phone == 'ERROR'">
                                <span class="text-xs text-red-400 font-semibold px-1">O campo Fone/Fax é obrigatório.</span>
                             </div>                      
                        </div>
                    </div> 
                   <div class="flex justify-end -mx-3 -ml-10 pl-2 pr-3 py-2 " v-if="edit">
                        ...
                        <div class="w-1/6 mb-5">
                            ...
                            <div class="flex">
                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                                <button @click="disableEdit()" class="w-full flex items-center justify-center bg-gray-600 text-white font-semibold rounded hover:bg-gray-700 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
    ...
    methods: {
        ...
        updateCompany() {
            ...
            if(this.$v.$anyError == false) {
                ...
                companyService.updateCompany(data).then((response) => {
