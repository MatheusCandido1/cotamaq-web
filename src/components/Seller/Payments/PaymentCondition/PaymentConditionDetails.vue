            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <label for="" class="text-sm font-semibold text-gray-600 px-1"
                  >Descrição da condição de pagamento</label
                >
                <div class="flex">
                  <div
                  ...
                  ></div>
                  <input
                    v-model="selectedPaymentCondition.description"
                    placeholder="Exemplo: Débito"
                    type="text"
...
export default {
  ...
  data() {
    return {
      selectedPaymentCondition: JSON.parse(
        JSON.stringify(this.$props.paymentCondition)
      ),
    };
  },
  methods: {
    updatePaymentCondition() {
      if (
        this.selectedPaymentCondition.description == "" ||
        !this.selectedPaymentCondition.description
      ) {
