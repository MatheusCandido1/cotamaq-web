          ...
          <div class="mt-1 px-2">
            <ul class="flex gap-2 justify-start">
                ...
                <div class="flex space-x-2 text-gray-800 text-sm  my-1">
                     <p><span class="font-semibold">Quantidade: </span>{{selectedProposal.quantity}}</p> 
                </div>
                <div class="flex space-x-2 text-gray-800 text-sm  my-1">
                ...
                <div class="flex space-x-2 text-gray-800 text-sm  my-1">
                     <p><span class="font-semibold">Peça Similar: </span>{{formatSimillar(selectedProposal.is_simillar)}}</p> 
                </div>
                <div class="flex space-x-2 text-gray-800 text-sm  my-1">
                     <p><span class="font-semibold">Marca: </span>{{selectedProposal.brand}}</p> 
                </div>
                <div class="flex space-x-2 text-gray-800 text-sm  my-1">
                     <p><span class="font-semibold">Observação: </span>{{selectedProposal.observation}}</p> 
                </div>
