                ...
                <div class="-mx-3 md:flex mb-6">
                    ...
                    <div class="flex flex-row justify-between">
                        <div class="py-1">
                            ...
                            <h2 v-if="estimate.address != null" class="text-2xl font-semibold text-center text-gray-700 dark:text-gray-200">
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        ...
                        <div class="md:w-1/6 px-3 mb-2 md:mb-0">
                            ...
                            <div class="flex">
                            <input id="discount" v-model="proposal.discount"  placeholder="" type="number" min="0" max="100" class="w-full pl-2 pr-3 py-2 rounded border-b-2 border-primary-main shadow-md py-2 px-6 outline-none  focus:border-primary-lighter">
