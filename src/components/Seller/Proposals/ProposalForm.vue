<template>
    ...
    <ProposalConfirm v-if="modal.confirm" v-bind:shipping="proposal.shipping" v-bind:notShowNewProposalBtn="estimate.allow_similar == 0 && true" @save="sendProposal" @close="closeConfirmModal" />
