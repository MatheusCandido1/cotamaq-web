              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                   Tem certeza que deseja enviar essa proposta?
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  props: ['proposal','paymentMethods','paymentConditions'],
  data() {
    return {
        detail: JSON.parse(JSON.stringify(this.$props.proposal)),
        selectedPaymentMethods:  this.$props.paymentMethods,
        selectedPaymentConditions:  this.$props.paymentConditions,
    }
  },
  methods: {
    close() {
