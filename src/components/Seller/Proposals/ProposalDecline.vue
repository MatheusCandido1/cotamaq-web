              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  ...
                  <p class="text-sm text-gray-600 mt-3">
                   Ao cancelar, você <span class="font-bold">NÃO</span> poderá propor uma oferta para essa cotação!
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    declineProposal() {
        this.disabled = true
        var proposalId = this.selectedProposal.proposals_by_seller[0].id
        proposalService.declineDraftProposalBySeller(proposalId).then((response) => {
